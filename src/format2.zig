//! format2.zig — v2 页格式常量与编解码（页头、meta、freelist、CRC）
...
test "format2: page header roundtrip" {
    const h = PageHeader{
        .page_no = 42,
...
test "format2: meta page roundtrip" {
    const meta = MetaPage{
        .magic = MAGIC_V2,
        .version = 2,
        .mapsize = 1 << 30,
...
test "format2: page checksum verification" {
